...
<br/>
예시는 노마드코더의 그큐엘 강의 + 그큐엘 공식문서에서 뽑았다. 객관성은 없고 내가 쓰면서 이해하려고 적은 부분이 큼을 미리 밝혀둔다ㅎ(쭈굴)  
<br/>
...
회사에서처럼 업무 분담이 돼있는 경우, 백엔드에서 한번 프론트에서 한번 데이터의 타입을 체크하는 게 안정성엔 더 도움이 될지 모르겠다. 나도 편하고 백엔더도 편하고. 속도가 더 빠르기도 하다. 그치만 혼자 할 때는 이게 옳은 방향이라고 느끼면 어떡할까? 그래서 tRpc는 계속 공부하면서 조만간 따로 포스팅해보려고 한다.! 쾅쾅  
<br/>
