...
블로그를 만들며 의도한 건 프로젝트 단위의 기억이었다. 내 경우 언제나 그렇지만 파편적인 기억보단 맥락 위의 기억을 더 깊게 오래 기억했다. 그래서 에러도 동떨어지기보단 큰 주제 속에서 함께 이해하고 싶었다.  
하지만 세상사 꼭 그렇지만은 않고 에러만 에러끼리 모아 보는 것도 나름 의미가 있을 것 같더라ㅎ 
