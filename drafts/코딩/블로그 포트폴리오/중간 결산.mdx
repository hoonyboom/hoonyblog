...
```
<br/>
이 컴퍼넌트들은 <Lnk text={'mdxBundler'} href={'https://github.com/kentcdodds/mdx-bundler'} />에 디스트럭션(props)으로 풀어 전달했다. 별도의 import 없이도 `mdx` 파일에서 곧장 사용할 수 있게 됐다.  
<br/>
#### 마크다운 태그
...
비단 mdx뿐만 아니라 개발 전반에 활용할 수 있는 보조 기능이기에 앞으로의 코딩에 많은 도움이 될 거 같다.
```json mdx.json
{
  "Image": {
    "prefix": "@img",
