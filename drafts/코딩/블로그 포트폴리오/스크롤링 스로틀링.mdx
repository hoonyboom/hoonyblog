...
소울 메이트로 디바운스가 있는데, <q>디바운스</q>는 내가 지정한 시간만큼 움직임이 멈춰있을 때 함수가 호출된단 점에서 차이가 있다. 한마디로  
<br/>
- 쓰로틀: *쿨타임*마다 한번 실행  
...
이해가 됐을까? 개념을 잡았다면 쓰면 된다. <q>lodash</q>에서는 이를 아주 쉽게 쓸 수 있게 함수로 제공해 주고 있다. 그리고 우리는 심장소리처럼 스크롤바를 경청할 예정이다. 따라서 디바운스가 아닌 쓰로틀을 걸어준다
