...
---
<HeadingNavigator />
포스팅이 늘어나면서 파일 관리가 점점 힘들어지게 됐다. 처음 Next 공식 튜토리얼을 따라갈 때 하나의 폴더를 대상으로만 `posts`를 읽히게 만들어놨기 때문이다. 용납된다 안된다? 당연히 안된다 🫥  
<br/>
...
<br/>
경로를 읽는 부분을 순환시켜야함이 마땅해 보였다. 근데 막상 해보려니 잘 안 됐다는 숨기고 싶은 비하인드가 있고..ㅎㅎ recursive한 구조에 아직 미숙한 것 같다😥 다행히 구글링으로 실마리를 찾을 수 있었다. [^1]
