...
<br/><br/><br/>
### 제네릭이 어떻게 짜여있길래?
이를 이해하기 위해선 다른 유틸 타입인 <a>Pick</a> 과 <a>Exclude</a> 의 쓰임을 먼저 알아야 했다. 내가 단박에 파악할 깜냥은 안 돼서 다른 분의 설명을 참고했고, 많은 도움이 됐다. 자세한 설명이라면 그분 걸 참고하는 게 나을 것 같다. 나는 내가 적고 내가 이해하는 데 아무래도 좀 더 주안을 두고 있기 때문이다.  
<br/>
